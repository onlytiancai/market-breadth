...
CREATE TABLE `zh_stocks_d` (
  `date` varchar(30) CHARACTER SET utf8mb4  NOT NULL COMMENT '日期',
  `code` varchar(20) CHARACTER SET utf8mb4  NOT NULL COMMENT '代码',
  `name` varchar(255) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT '名称',
  `industry` varchar(255) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT '行业',
  `sw_ind1` varchar(255) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT '申万一级行业',
  `sw_ind1_weight` decimal(20,3) DEFAULT NULL COMMENT '申万一级行业权重',
  `area` varchar(255) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT '地区',
  `market` varchar(255) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT '市场',
  ...
  `is_gap` varchar(10) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT '是否有缺口',
  ...
  `is_cs_over` varchar(10) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT '是否破线（上穿）',
  `sm` decimal(20,3) DEFAULT NULL COMMENT 'S/M',
  `psm` decimal(20,3) DEFAULT NULL COMMENT '前一日 S/M',
  `is_sm_over` varchar(10) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT '是否交叉(MA20上穿MA60)',
  `ml` decimal(20,3) DEFAULT NULL COMMENT 'M/L',
  `pml` decimal(20,3) DEFAULT NULL COMMENT '前一日 M/L',
  `is_ml_over` varchar(10) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT '是否交叉(MA60上穿MA120)',
  ...
  `is_esm_over` varchar(10) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT '是否交叉(EMA20上穿EMA60)',
  `eml` decimal(20,3) DEFAULT NULL COMMENT 'EMA M/L',
  `peml` decimal(20,3) DEFAULT NULL COMMENT '前一日 EMA M/L',
  `is_eml_over` varchar(10) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT '是否交叉(EMA60上穿EMA120)',
  ...
  `is_s_up` varchar(10) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT 'MA20 是否向上拐头',
  `m_close` decimal(20,3) DEFAULT NULL COMMENT 'MA60 抵扣价 ',
  `m_pre_close` decimal(20,3) DEFAULT NULL COMMENT 'MA61 抵扣价 ',
  `is_m_up` varchar(10) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT 'MA60 是否向上拐头',
  `l_close` decimal(20,3) DEFAULT NULL COMMENT 'MA120 抵扣价 ',
  `l_pre_close` decimal(20,3) DEFAULT NULL COMMENT 'MA121 抵扣价 ',
  `is_l_up` varchar(10) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT 'MA120 是否向上拐头',
